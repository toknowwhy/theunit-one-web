...
export default function IndexPage() {
  ...
  return (
    <PageContainer>
      ...
      <Fade direction="up" cascade triggerOnce>
        <div className={styles.splineRowWrapper}>
          <div className={styles.pageContainer}>
            <Row className={styles.tableRow} gutter={{ md: 32, lg: 32 }}>
              <Col xs={24} sm={24} md={12} className={styles.tableContentCol}>
                <div className={styles.spline}>
                  <Spline scene="https://prod.spline.design/noP1fbdLdVrd-p58/scene.splinecode" />
                </div>
              </Col>
              <Col xs={24} sm={24} md={12} className={styles.splineTextWrapper}>
              <div className={styles.pageTitle} style={{ textAlign: 'left' }}>UNIT</div>
              <p>The first ever unbiased unit of value encapsulated in a coin.</p>
              <p>Vaults to mint UNIT will be available later in 2022. Follow us and hold the unit of crypto.</p>
              </Col>
            </Row>
          </div>
        </div>
